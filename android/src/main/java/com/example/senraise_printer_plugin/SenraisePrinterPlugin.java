package com.example.senraise_printer_plugin;
...
public class SenraisePrinterPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "senraise_printer_plugin");
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    try {
      if (call.method.equals("getPlatformVersion")) {
        ...
        result.success("printPicture success");
      ...
      Log.e("senraise_printer_plugin",e.getMessage());
    }
  }
